    ...
    def score(self, metrics):
        ...
        for metric_name in metrics:
            if metric_name in [
                ...
                "gpt2_medium_score", "gpt2_large_score", "gpt2_xl_score", "gptJ6B_score", "llama_score"
                ]:
                ...
                metric2checkpoint = {
                    ...
                    "llama_score": "decapoda-research/llama-7b-hf"
                }
...
def main():
    ...
    parser.add_argument("--llama_score", type=str2bool, default=False,
                        help="Whether to calculate llama_score.")
