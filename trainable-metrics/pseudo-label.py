...
if __name__ == "__main__":
    parser = ap.ArgumentParser(prog='pseudo-label.py', description='Pseudo-labeling script')
    parser.add_argument('--model', type=str, help='Model name', default="Unbabel/wmt22-comet-da")
    ...
    dataset = [
        {
            ...
            "mt": mt,
            "ref": ref,
        } for src, mt, ref in tqdm(zip(dataset["src"], dataset["mt"], dataset["ref"]), unit_scale=True)
    ]
